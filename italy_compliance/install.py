...
from italy_compliance import fiscal_regimes, tax_exemption_reasons, mode_of_payment_codes, vat_collectability_options


def after_install():
	make_custom_fields()
	setup_report()  # remove the report later from erpnext regional
	add_permissions()
...
def make_custom_fields(update=True):
	...
	custom_fields = {
		...
		'Purchase Taxes and Charges': [  # 'parenttype' field doesn't exist
			dict(fieldname='tax_rate', label='Tax Rate',
